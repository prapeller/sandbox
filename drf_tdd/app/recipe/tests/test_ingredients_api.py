...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        recipe1 = Recipe.objects.create(title='Apple crumble', time_minutes=5, price=10.00, user=self.user)
        recipe1.ingredients.add(ingredient)
        recipe2 = Recipe.objects.create(title='Apple crumble2', time_minutes=5, price=10.00, user=self.user)
